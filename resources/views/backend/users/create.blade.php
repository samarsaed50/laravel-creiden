...
@section('content')
    {{ html()->form('POST', route('admin.users.store'))->class('form-horizontal')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">@lang('labels.backend.users.create')</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
            ...
            <div class="row mt-4 mb-4">
                <div class="col">
                    ...
                    <div class="form-group row">
                        {{ html()->label(__('labels.backend.users.name'))->class('col-md-2 form-control-label')->for('name') }}
